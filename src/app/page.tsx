...
import { DownloadCloudIcon, GlobeIcon, MailIcon, PhoneIcon } from "lucide-react";
  ...
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
          ...
          {RESUME_DATA.certificates.map((certificate) => {
            return (
              <Card key={certificate.title}>
                ...
                <CardContent className="mt-2">{certificate.title}</CardContent>
              </Card>
            );
          })}
        </Section>
        ...
        <Section>
          <h2 className="text-xl font-bold">Opensource Contributions</h2>
          {RESUME_DATA.openSourceContributions.map((project) => (
            <Card key={project.organization}>
              <CardHeader>
                <div className="flex items-center justify-between gap-x-2 text-base">
                  <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
